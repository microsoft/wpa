...
<B>
  <font size="+3">
    Flexibility - Are employees embracing flexible work schedules?
  </font>
</B>
<br>
<br>
...
flex2_w1_plot +
  labs(title = "Define start times",
       subtitle = paste("% of weeks employees define start times"))
...
### Percentage of weeks employees take breaks during the day
...
paste(KPI_3, "% take breaks") %>%
  flexdashboard::valueBox(icon = "fa-stopwatch",
                          color = rgb2hex(1, 147, 157))
						  
```

### <B>Are employees taking pre-defined breaks?</B> <br> Employees should have the freedom to choose when to take breaks during the day. In teams that embrace flexibility, some members will choose to organize / split their day in different ways (e.g. take a long lunch-break, disconnect in the afternoon and reconnect in the evening, etc.)
...
flex2_w3_plot +
  labs(title = "Take breaks",
       subtitle = paste("% of weeks employees take breaks"))
...
paste(KPI_2, "% control hours") %>%
  flexdashboard::valueBox(icon = "fa-balance-scale",
                          color = "#00508F")
						  
```

### <B>Are employees able to disconnect after work?</B> <br> Employees who choose alternative work schedules should be able to maintain a workload that is broadly equivalent to the standard 8 hours. Flexible working should not result in longer hours spread across the day. 
...
flex2_w2_plot +
  labs(title = "Control hours",
       subtitle = paste("% of weeks employees control hours"))
