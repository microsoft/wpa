...
create_tracking(
  ...
  plot_subtitle = "% of company active on the weekend",
  percent = TRUE
)
```
...
my_sq_data %>%
  ...
  create_tracking(
    ...
    plot_subtitle = "Average after hours collaboration for urgent weeks",
    percent = FALSE
)
...
my_sq_data %>%
  ...
  create_tracking(
    ...
    plot_subtitle = "% of meeting time in a small group setting",
    percent = TRUE
)
