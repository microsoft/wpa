...
So far, we have limited our analysis to `collaboration_rank()`, which only performs the analysis on the metric `Collaboration_hours`. However, the [**wpa** R package](https://microsoft.github.io/wpa) includes many other rank functions for key Workplace Analytics metrics:
