...
This article is a first introduction to the topic of Organizational Network Analysis but there is a lot more to come. Here are some references that give more information about how to use the wpa R package and the topic of Networks:

- [Overview](https://microsoft.github.io/wpa/reference/index.html) of functions of the wpa R package
- [Reports](https://microsoft.github.io/wpa/analyst_guide_reports.html) that you can run using the wpa R package
- [Handbook](https://ona-book.org/index.html) of Graphs and Networks in People Analytics
